...
public static class Functions
{
    ...
    public static Func<int, IResult<TReturn>> GetExceptionFunction<TReturn>() { return _ => throw Errors.ExceptionThrown; }

    public static Func<int, CancellationToken, Task<IResult<TReturn>>> GetExceptionAsyncFunction<TReturn>() { return (_, _) => throw Errors.ExceptionThrown; }

    public static Func<IResult<TReturn>> GetNoParamExceptionFunction<TReturn>() { return () => throw Errors.ExceptionThrown; }

    public static Func<CancellationToken, Task<IResult<TReturn>>> GetNoParamExceptionAsyncFunction<TReturn>() { return _ => throw Errors.ExceptionThrown; }
    ...
    public static Action GetNoParamAction() { return () => { Values.FunctionWasCalled = true; }; }
    ...
    public static Action<int> GetExceptionAction() { return _ => throw Errors.ExceptionThrown; }

    public static Func<int, CancellationToken, Task> GetExceptionAsyncAction() { return (_, _) => throw Errors.ExceptionThrown; }

    public static Action GetNoParamExceptionAction() { return () => throw Errors.ExceptionThrown; }

    public static Func<CancellationToken, Task> GetNoParamExceptionAsyncAction() { return _ => throw Errors.ExceptionThrown; }
    ...
    public static Func<int?, CancellationToken, Task<IResult<int>>> GetNullableExceptionFunctionAsync() { return (_, _) => throw Errors.ExceptionThrown; }
}