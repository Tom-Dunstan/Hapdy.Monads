...
public class Then_ExceptionFailure
{
    ...
    [Test]
    public void When_SuccessFunctionExpectsNoParam_Then_DoesNotRunSuccessFunction()
    {
        // Arrange
        const string testErrorMessage         = "Testing binding failure result.";
        var          testException            = new Exception(testErrorMessage);
    ...
    [Test]
    public async Task When_SuccessFunctionExpectsNoParam_Then_DoesNotRunSuccessFunctionAsync()
    {
        // Arrange
        const string testErrorMessage         = "Testing binding failure result.";
        var          testException            = new Exception(testErrorMessage);
    ...
    [Test]
    public async Task When_AsyncSuccessFunctionExpectsNoParam_Then_DoesNotRunSuccessFunction()
    {
        // Arrange
        const string testErrorMessage         = "Testing binding failure result.";
        var          testException            = new Exception(testErrorMessage);
    ...
    [Test]
    public async Task When_AsyncSuccessFunctionExpectsNoParam_Then_DoesNotRunSuccessFunctionAsync()
    {
        // Arrange
        const string testErrorMessage         = "Testing binding failure result.";
        var          testException            = new Exception(testErrorMessage);
