...
public static partial class ResultHelper
{
    ...
    {
        /// <summary>
        ///     Runs the <paramref name="exceptionFunc" /> if the result is a ExceptionFailure result. Otherwise, returns the
        ///     result.
        /// </summary>
    ...
    {
        /// <summary>
        ///     Runs the <paramref name="exceptionFunc" /> if the result is an ExceptionFailure result. Otherwise, returns the
        ///     result.
        /// </summary>
        /// <param name="exceptionFunc">Function to handle exceptions</param>
        /// <returns>A result after handling exceptions</returns>
