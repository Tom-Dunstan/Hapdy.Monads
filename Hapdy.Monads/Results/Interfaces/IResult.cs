...
public interface IResult
{
        ...
        where T : notnull
    {
        try
        {
            return func(value, cancellationToken);
        }
        catch (Exception e)
        {
            return Task.FromResult((IResult<TValue>)new ExceptionFailure<TValue>(e));
        }
    }
...
public interface IResult<out T> : IResult
{
        ...
        , CancellationToken cancellationToken)
    {
        ...
        {
            return Task.FromResult((IResult<T>)new ExceptionFailure<T>(e));
        }
    }
